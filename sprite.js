...
function Sprite(x, y, largura, altura) {
    ...
    this.desenha = function(xCanvas, yCanvas) {
        ctx.drawImage(img, this.x, this.y, this.largura, this.altura, xCanvas, yCanvas, this.largura, this.altura);  // Desenha imagem na tela
    }
}

// Passando as codernadas da imagem para forma os desenhos na tela
